...
interface FreeTimeQuestionProps {
...
export default function FreeTimeQuestion({ selectedOption, onSelect, onNext, onBack }: FreeTimeQuestionProps) {
  const options = ["Time with Friends and Family", "Exercising", "Hobbies", "Other..."];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full px-4">
      <div className="w-full max-w-md mb-8">
        ...
        <h2 className="text-xl font-medium text-gray-700 text-center mb-8">What do you enjoy in your free time?</h2>
