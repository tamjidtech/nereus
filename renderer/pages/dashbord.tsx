...
import { ChevronDown, CreditCard, LayoutGrid, LineChart, Menu, Play, Plus, Settings, X } from "lucide-react"
        ...
        <div className="flex flex-col md:flex-row min-h-screen bg-white relative">
            ...
            <div className="flex-1 p-4 md:p-8 flex flex-col items-center overflow-y-auto">
                <div className="max-w-3xl w-full">
                    <h1 className="text-2xl md:text-3xl font-medium text-blue-900 mb-6 md:mb-8 text-center">What&apos;s Your Session Goal?</h1>
                    <div className="flex flex-col sm:flex-row items-center justify-center mb-8 md:mb-12 w-full">
                        <input
                            type="text"
                            value={sessionGoal}
                            onChange={(e) => setSessionGoal(e.target.value)}
                            placeholder="Session Goal..."
                            className="w-full sm:w-[300px] h-[57px] p-4 border border-gray-300 rounded-md mb-4 sm:mb-0 sm:mr-4"
                        />
                        <button className="w-full sm:w-auto bg-[#38B6FF] text-white px-6 sm:px-10 py-4 rounded-lg font-medium text-lg">Enter</button>
                    </div>
                    ...
                    <div className="mb-8 w-full flex flex-col items-center">
                        ...
                        <button className="bg-[#38B6FF] text-white py-4 px-6 rounded-lg font-medium text-lg shadow-md hover:bg-[#1E90FF] transition w-full sm:w-auto">
                            Start Session (+30)
                        </button>
                    </div>
                </div>
            ...
            <div className="hidden md:block w-[300px] border-l border-gray-200 p-6">
                <div className="flex items-center mb-8 bg-[#F6FCFE] rounded-[16px] w-full h-[73px]">
                ...
                <div className="flex flex-col gap-4 items-center">
                    ...
                    <div
                        className="flex flex-col p-4 bg-[#FCFEFE] border border-[#F3F3F3] rounded-md w-full gap-2 shadow-md 
