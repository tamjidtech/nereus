import { Check, ChevronDown, CreditCard, LayoutGrid, LineChart, Menu, Settings } from "lucide-react";
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-white">
            ...
            <div className="flex-1 p-6">
                {/* Mobile Menu Button */}
                <button onClick={() => setIsSidebarOpen(true)} className="md:hidden mb-4 text-gray-600">
